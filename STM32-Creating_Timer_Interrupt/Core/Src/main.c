...
osThreadId myTaskInitTimerHandle;
osThreadId myTaskInitNVICHandle;
...
int main(void)
{
  ...
  /*	myTaskInitTimer Init	*/
  osThreadDef(myTaskInitTimer, TIM2_Init, osPriorityHigh, 0, 128);
  myTaskInitTimerHandle = osThreadCreate(osThread(myTaskInitTimer), NULL);

  /*	myTaskInitNVIC Init*/
  osThreadDef(myTaskInitNVIC, NVIC_Update, osPriorityHigh, 0, 128);
  myTaskInitNVICHandle = osThreadCreate(osThread(myTaskInitNVIC), NULL);
